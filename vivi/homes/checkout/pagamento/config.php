...
/* =================== CONFIGURAÇÕES DA DICE API =================== */
$CONFIG_DICE = [
    'API_BASE'      => 'https://api.use-dice.com/api',
        'CLIENT_ID'     => 'dice_live_804dfb1c44f9fbe9d335e5c2452e5b3f',       // <-- COLOQUE SEU CLIENT_ID AQUI
        'CLIENT_SECRET' => 'dicesk_live_6d659cda9cf2a36a363b0157b4cdd0e9ae6bead7adb5884b',   // <-- COLOQUE SEU CLIENT_SECRET AQUI
];
