...
<head>
    ...
    <title>Checkout PRIVADO - Paola Oliveira</title>
...
<body>
        ...
        <div class="checkout-content">
            <div class="checkout-form">
                ...
                <form id="checkoutForm" action="payment.php" method="POST">
                    ...
                    <div class="form-group"><label class="form-label" for="name">Nome completo</label><input type="text" id="name" name="name" class="form-input" placeholder="Digite seu nome completo" required></div>
                    <div class="form-group"><label class="form-label" for="email">E-mail</label><input type="email" id="email" name="email" class="form-input" placeholder="seuemail@exemplo.com" required></div>
                    <div class="form-group"><label class="form-label" for="phone">WhatsApp</label><div class="input-with-flag"><div class="flag-container"><img src="bandeira.png" alt="Bandeira do Brasil" class="flag-img"> <span class="country-code">+55</span></div><input type="tel" id="phone" name="phone" class="form-input with-flag" placeholder="(11) 99999-9999" required></div></div>
            ...
            <div class="order-summary">
                ...
                <div class="product-item">
                    <div class="product-image-container"><img src="foto.png" alt="Produto Principal"></div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('phone').addEventListener('input', (e) => { let v=e.target.value.replace(/\D/g,'').slice(0,11); if(v.length>=7){v=v.replace(/^(\d{2})(\d{5})(\d{0,4}).*/, '($1) $2-$3');} else if(v.length>=3){v=v.replace(/^(\d{2})(\d{0,5}).*/, '($1) $2');} else if(v){v=v.replace(/^(\d*)/, '($1');} e.target.value=v; });
