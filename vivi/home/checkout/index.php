...
<head>
  ...
  <script>
    ...
    fbq('track', 'ViewContent', {
      content_name: 'Privacidad - Thalita Xavier',
            ...
            <div style="display: flex; flex-direction: column; gap: 15px">
              ...
              <div class="post-card">
                ...
                <div class="post-content">
                  <div class="post-video-container" style="background-color: #000;"><video src="assets/listing7.mp4" class="post-video" autoplay
                      loop muted playsinline style="opacity: 0.25; filter: blur(3px);"></video>
              ...
              <div class="post-card">
                ...
                <div class="post-content">
                  <div class="post-video-container" style="background-color: #000;"><video src="assets/listing8.mp4" class="post-video" autoplay
                      loop muted playsinline style="opacity: 0.25; filter: blur(3px);"></video>
                    <div class="video-overlay">
                      <div class="lock-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none"
                          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="post-card">
                ...
                <div class="post-content">
                  <div class="post-video-container" style="background-color: #000;"><video src="assets/listing9.mp4" class="post-video" autoplay
                      loop muted playsinline style="opacity: 0.25; filter: blur(3px);"></video>
                    <div class="video-overlay">
                      <div class="lock-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none"
                          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
